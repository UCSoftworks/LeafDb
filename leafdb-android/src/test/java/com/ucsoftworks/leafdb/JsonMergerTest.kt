...
import com.ucsoftworks.leafdb.serializer.JsonMergerTest
...
class JsonMergerTest {
    ...
    data class C(val i: Int, val s: String, val a: JsonMergerTest.A, val l: List<String>, val n: Any)
    ...
    fun mergePlainTest() {
        ...
        val merge = jsonMerger.merge(JsonMergerTest.A(5, "asd"), json)


        val b = jsonMerger.getObjectFromJson(merge!!, JsonMergerTest.B::class)
    ...
    fun mergeTreeTest() {
        ...
        val merge = jsonMerger.merge(new, old)


        val c = jsonMerger.getObjectFromJson(merge!!, JsonMergerTest.C::class)
